...
class UserSlipWidget extends StatefulWidget {
  final String accountName,matchId,type,winNumber;
  const UserSlipWidget({Key? key,required this.matchId,required this.type,required this.accountName,required this.winNumber}) : super(key: key);

  @override
  State<UserSlipWidget> createState() => _UserSlipWidgetState();
}

class _UserSlipWidgetState extends State<UserSlipWidget> {
  @override
